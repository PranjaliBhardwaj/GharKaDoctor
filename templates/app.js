...
const searchskin = () => {
    const searchbox2 = document.getElementById("searchbar").value.toUpperCase();
    const storeXXX = document.querySelector("med"); // Corrected this line
    const product2 = storeXXX.querySelectorAll(".med1"); // Corrected this line
    const pname2 = storeXXX.getElementsByTagName("h3");
